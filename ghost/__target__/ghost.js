// Transcrypt'ed from Python, 2020-12-30 18:46:34
...
import {add_background, add_image, add_text, click, element_id, get_next_id, move_down, move_up, position_element, py_clear, remove_element, set_text_color, translate_y, update_text, vanish} from './builtins.js';
...
for (var _ = 0; _ < num_ghosts; _++) {
	...
	var lowest_x_value = 0;
	var highest_x_value = 1200;
	var ghost_x = randint (lowest_x_value, highest_x_value);
	var ghost_y = 1000;
